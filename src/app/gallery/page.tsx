  ...
  return (
    <section className="relative overflow-hidden border-b border-border/60">
      ...
      <Container className="relative py-16 sm:py-20">
        ...
        <a
          className="mt-8 inline-flex h-10 items-center justify-center rounded-full border border-highlight/60 bg-highlight/10 px-5 text-xs font-semibold uppercase tracking-[0.3em] text-highlight transition-colors hover:bg-highlight/20"
          href={instagramUrl}
          target="_blank"
          rel="noreferrer"
        >
